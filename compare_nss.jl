...
sim_res1 = run_sim(FT(22),FT(1.5), FT(5), FT(1e-4), FT(2.5), FT(2.0), FT(700),FT(0.45),istart,N, soil_init1);

sim_res1_time = @timed run_sim(FT(22),FT(1.5), FT(5), FT(1e-4), FT(2.5), FT(2.0), FT(700),FT(0.45),istart,N, soil_init1);
...
include("rebuild_sim_ij_mycap.jl")
println("New capacitance")

sim_res3 = run_sim(FT(22),FT(1.5), FT(5), FT(1e-4), FT(2.5), FT(2.0), FT(700),FT(0.45),istart,N, soil_init1, 1);

sim_res4_time = @timed run_sim(FT(22),FT(1.5), FT(5), FT(1e-4), FT(2.5), FT(2.0), FT(700),FT(0.45),istart,N, soil_init1, 50);
