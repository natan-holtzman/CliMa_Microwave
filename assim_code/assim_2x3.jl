...
sim_res1 = convert_sim(run_sim(FT(22),FT(0.33), FT(5.0),FT(1e-4), FT(800),istart,N, soil0, FT(0),0,FT(2),FT(2)));
#vcmax_par, p_crit, k_plant, k_soil, z_soil, istart, N, smc0, slope_index,use_flux
