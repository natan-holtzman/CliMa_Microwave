...
for i in range(3):
    p0 = np.array(pd.read_csv(out_folder+subdir_list[i]+"post_par.csv"))[6000:,:11]
    p1 = np.array(pd.read_csv(out_folder+subdir_list2[i]+"post_par.csv"))[6000:,:11]
    p2 = np.array(pd.read_csv(out_folder+subdir_list3[i]+"post_par.csv"))[6000:,:11]
    p3 = [p0,p1,p2]
    leafpars.append(p3)
