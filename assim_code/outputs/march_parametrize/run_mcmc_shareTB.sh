...
init_names=("o1AMPM_c1/opt_par.csv" "o6AMPM_c1/opt_par.csv" "oAll_c1/opt_par.csv" "o1AMPM_c1/opt_par.csv" "o6AMPM_c1/opt_par.csv" "oAll_c1/opt_par.csv" "o1AMPM_c1/opt_par.csv" "o6AMPM_c1/opt_par.csv" "oAll_c1/opt_par.csv")
