...
order_index = [2,5,4,10,3,0,6,1,7,8,9,11]
...
subdir_list = ["oAll_c3/", "o1AMPM_c3/", "o6AMPM_c3/", "o1and6_c3/"]

par_post = []
for x in subdir_list:
    g1 = np.array(pd.read_csv(out_folder+x+"post_par.csv"))[-4000::100,:12];
    par_post.append(g1)
...
subdir_list = ["oAll_c1/", "o1AMPM_c1/", "o6AMPM_c1/", "o1and6_c1/"]
...
prior_min = [10, 0.75, 0.1, 500, 0.01+0.75,  0.01*12,100,0.1,0.3,0.01,1,1.1];
prior_max = [120,15,  50, 3000, 10+15, 10*12,1000, 20,0.5,5,8,1.9];
...
for ax in ax_all.ravel():#[:7]:
    ...
    ax.hlines(np.log(true_val[j]), 0, 5, color="black")
