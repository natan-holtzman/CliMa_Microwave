...
function run_scenario(scenario, sout, s_in)
  ...
  if scenario == "o1AMPM"
    do_assim(mask1, 1, sout, vA, vB, vC,vO, s_in) 
  

  elseif scenario == "o6AMPM"
    do_assim(mask6, 1, sout, vA, vB, vC,vO, s_in)
  

  elseif scenario == "o1AM"
    do_assim(mask1o, 2, sout, vA, vB, vC,vO, s_in)

  elseif scenario == "o1and6"
    do_assim(mask1and6, 1/2, sout, vA, vB, vC,vO, s_in)

  elseif scenario == "o16offset"
    do_assim(mask16offset, 1/2, sout, vA, vB, vC,vO, s_in)
  

  elseif scenario == "oAll"
    do_assim(maskAll, 1.0/36, sout, vA, vB, vC,vO, s_in)
  end
end
