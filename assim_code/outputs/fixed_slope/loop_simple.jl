...
vA, vB, vC, vO = (0.067, 0.82, 0.051, 0.05);

function run_scenario(scenario, sout, s_in, my_init)
  #sout = string(scenario,"/")
  if scenario == "o1AMPM"
    do_assim(mask1, 1, sout, vA, vB, vC,vO, s_in, my_init) 
  ...
  elseif scenario == "o1and6"
    do_assim(mask1and6, 1.0/2, sout, vA, vB, vC,vO, s_in, my_init)

  elseif scenario == "o16offset"
    do_assim(mask16offset, 1/2, sout, vA, vB, vC,vO, s_in, my_init)
  

  elseif scenario == "oAll"
    do_assim(maskAll, 1.0/36, sout, vA, vB, vC,vO, s_in,my_init)
  end
end
