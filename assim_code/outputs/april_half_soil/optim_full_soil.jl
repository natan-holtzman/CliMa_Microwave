...
alpha2 = FT(10.9*2)*abs(pot1b); 
return run_sim_BallBerry(vcmax_par, weibB_stom, weibB_stom+xylem_extraB, weibC_plant, k_plant,
...
prior_min = [10, 0.75, 0.1, 500, 0.01,  0.01,1,0.1e-6,0.3,0.01,1,1.1];
prior_max = [120,15,  50, 3000, 10, 10,120,    20e-6,0.5,5,8,1.9];
...
myopt = optimize(mywrapper, a01,NelderMead(initial_simplex = MySimplexer()),   
 Optim.Options(show_trace=true,iterations=5000,store_trace=true))
