...
fname = "postET.csv"
print(fname)
ETmean = do_compare(fname)
ETmean *= 18.02/1000*60*60*24


fname = "postGPP.csv"
print(fname)
GPPmean = do_compare(fname)

fname = "postSWS.csv"
print(fname)
SMCmean= do_compare(fname)
...
np.save("mean2007.npy",np.array(all_means))
