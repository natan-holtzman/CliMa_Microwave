...
function run_sim_2(vcmax_par::FT, k_plant::FT, k_soil::FT, z_soil::FT, weibB::FT, weibC::FT, vol_factor::FT)
	return run_sim_vary(vcmax_par, weibB, weibC, k_plant, k_soil, z_soil, istart, N, soil0, vol_factor, 1e-5, 3, df_raw, deltaT, alpha, nsoil);
end

sim_res1 = run_sim_2(FT(22), FT(2),FT(1e-5), FT(600),FT(4.0),FT(3),FT(1));
...
prior_min = [10, 0.1,  1e-6, 500, 0.75, 0.75, 0.1];
prior_max = [120, 100, 2e-5, 3000, 10, 8, 10];
