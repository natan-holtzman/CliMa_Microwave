...
function get_TB(sim_res, leafpot, pvs, alpha, beta,omega,roughness)
...
function optim_vod_while2(obsHi, obsVi, leafpot, smc_mod, Tsoil, Tcan, laiM, k, alpha, beta,rhfac,omega, maxiter, stop_crit, step_size)
...
return [k, alpha, beta,rhfac,omega, total_err_old, itercount];
end
